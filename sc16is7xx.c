...
/* ================= jhw ======================*/
#if LINUX_VERSION_CODE < KERNEL_VERSION(5,10,103)
#ifndef SPI_MODE_X_MASK
#define SPI_MODE_X_MASK (SPI_CPHA | SPI_CPOL)
#endif
#ifndef HZ_PER_MHZ
...
static const struct of_device_id __maybe_unused sc16is7xx_dt_ids[] = {
	...
	//{ .compatible = "nxp,sc16is762",	.data = &sc16is762_devtype, },
    	{ .compatible = "cantops,sc16is752-ext", .data = &sc16is752_devtype, },
    	{ .compatible = "cantops,sc16is752_ext", .data = &sc16is752_devtype, },
	{ }
};
...
static const struct spi_device_id sc16is7xx_spi_id_table[] = {
	...
	{ "sc16is752-ext", (kernel_ulong_t)&sc16is752_devtype, },
	{ "sc16is752_ext", (kernel_ulong_t)&sc16is752_devtype, },
	{ }
};
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("cantops");
MODULE_DESCRIPTION("SC16IS7XX ext serial driver v5.10.240");
